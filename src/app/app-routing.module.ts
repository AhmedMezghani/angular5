...
const routes: Routes = [
  {
    path:'admin/:idUser', component:AllTemplateAdminComponent,
    children:[
      ...
      {path:'promtion-admin-create/:id',component: CreatePromotionComponent},
      ...
      {path:'produit-list-Promotion', component: ProduitListComponent},
      {path:'catalogues', component: CatalogueAdminComponent},
  ...
  },
  {
    ...
    children:[
      ...
      {path:'buyer/:idUser',component:AllTemplateUserComponent,children:[{path:'',component:HomeBuyerUserComponent},{path:'chat',component:ChatComponent}]},
      {path:'livreur/:idUser',component:HomeLivreurUserComponent},
      {path:'provider/:idUser',component:HomeProviderUserComponent},
      {path:'vendor/:idUser',component:HomeVendorUserComponent},
